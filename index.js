...
/////////////////
const BotName = 'CYLO BOT☄'; 
const instagram = 'https://instagram.com/literasi ruwet18'; 
const telegram = 'https://t.me/P1C0LO'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/gada yt';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@literasi ruwet18')
